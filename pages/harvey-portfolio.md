...
title: "Work Sample: Recital Program"
permalink: "/harvey-portfolio/"
header:
...
<div class="row">
  <div class="medium-4 columns">
    <div class="center flex-video widescreen vimeo">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/u7Ih4gF684A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <a href="{{ site.url }}{{ site.baseurl }}/pdfs/one-flesh.pdf" target="_blank" class="button radius small expand">Score ›</a>
  </div>
  <div class="medium-8 columns">
    <h2 class="no-margin"> One Flesh <span class="body-teaser">for flute, string quartet, &#38; piano</span></h2>
    <br>
    <table style="width: 100%; margin-bottom: 20px; margin-top: -10px;">
      <tr>
        <td><b>Suggested Excerpt #1</b></td>
        <td>6:01–7:32</td>
        <td>Romance: Layla & Majnun,<br>measures 1–22</td>
        <td>pp. 27–28</td>
      </tr>
      <tr>
        <td><b>Suggested Excerpt #2</b></td>
        <td>15:35–16:51</td>
        <td>Canon: Bacchus & Ampelus,<br>measures 1–120</td>
        <td>pp. 42–49</td>
      </tr>
    </table>
    <p><i>Commissioned by Salastina. Performed May 11, 2024 by Salastina.</i></p>
    <p>Inspired by the unity born of divine love, each movement features a different instrumental duo, intertwining them in myriad ways until they become one.</p>
  </div>
</div>
<hr>
<!-- Gulistan -->
...
<div class="row t10">
 <div class="medium-4 columns">
   <div class="center flex-video widescreen vimeo">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/AO6xUSScIKI?start=47&end=485" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
   </div>
  <div class="medium-8 columns">
    <p>Instead of sharing a biography here, as would be a typical on a recital program, I would like to share an excerpt from a 2022 podcast interview in which I discuss my path to Jesus Christ by way of Bach. The video will automatically begin at 0:47 and end at 8:05.</p>
    </div>
</div>